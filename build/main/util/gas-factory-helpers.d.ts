...
export declare function getArbitrumBytes(data: string): Promise<BigNumber>;
export declare function calculateArbitrumToL1FeeFromCalldata(calldata: string, gasData: ArbitrumGasData, chainId: ChainId): Promise<[BigNumber, BigNumber, BigNumber]>;
...
export declare function getL2ToL1GasUsed(data: string, chainId: ChainId): Promise<BigNumber>;
