...
export declare class Quote extends BaseCommand {
    ...
    static flags: {
        ...
        forceMixedRoutes: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
        simulate: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
        debugRouting: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
        enableFeeOnTransferFeeFetching: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
        requestBlockNumber: import("@oclif/parser/lib/flags").IOptionFlag<number | undefined>;
        gasToken: flags.IOptionFlag<string | undefined>;
